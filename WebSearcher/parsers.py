...
def parse_serp(soup, serp_id=None, verbose=False):
    """Parse a Search Engine Result Page (SERP)
    
    Args:
        soup (bs4 object): a SERP that has been converted to BeautifulSoup
    ...
    for cmpt_rank, (cmpt_loc, cmpt) in enumerate(cmpts):
        ...
        parsed_cmpt = parse_component(cmpt, cmpt_type, cmpt_rank)
