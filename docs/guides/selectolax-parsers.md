...
- `scripts/bench_parse.py` is the perf gate. Run `--iterations 5 --runs 3` and compare median ms/SERP against the baseline noted in the most recent perf commit message.
